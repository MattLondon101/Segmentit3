package com.matt.android.segthree.utils;
...
public class ImagePicker {
    ...
    public static Intent getPickImageIntent(Context context) {
        ...
        Uri contentUri = FileProvider.getUriForFile(context, "com.matt.android.segthree.fileprovider", getTempFile(context));
    ...
    public static Bitmap getImageFromResult(Context context, int resultCode, Intent imageReturnedIntent) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            if (isCamera) {
                selectedImage = FileProvider.getUriForFile(context, "com.matt.android.segthree.fileprovider", imageFile);
